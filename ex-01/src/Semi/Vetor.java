...
public class Vetor<T> {
    ...
    public boolean substituir(T antigo, T novo) {
        for (int i = 0; i < this.tamanho; i++) {
    ...
    public boolean adicionarSeNaoExiste(T elemento) {
        if (busca(elemento) == -1) {
    ...
    public boolean inserirDepois(T referencia, T elemento) {
